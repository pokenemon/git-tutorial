...
aws cloudformation create-stack --stack-name "$clf_stack_name" --template-body file://deploy/"$riff_env"/"$clf_template_name" --role-arn "arn:aws:iam::304075530149:role/admin-role"
